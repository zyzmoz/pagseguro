(function(){
    ...
    pagseguro = (function(){
        ...
        pagseguro.prototype.setSender = function(obj){
            this.payment.sender.bornDate = obj.bornDate;
            this.payment.sender.phone = obj.phone;      
            this.payment.sender.email = obj.email;
            this.payment.sender.documents.document = obj.document;
